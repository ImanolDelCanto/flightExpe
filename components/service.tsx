...
import helice from "@/app/animations/helice.json"
...
export function Service() {
  ...
  return (
    <div id="service" className="pb-16">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div ref={ref} className="flex flex-col items-center mb-8">
          {shouldAnimate && (
            <Lottie animationData={helice} loop={false} className="w-36 h-36 mx-auto" autoplay={true} />
          )}
          <h2 className="text-3xl font-bold text-center mt-4 mb-12 text-gray-900 dark:text-white">
            Nuestros Servicios
          </h2>
        </div>
